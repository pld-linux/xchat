...
install -d $RPM_BUILD_ROOT/{usr/X11R6/share/pixmaps,etc/X11/applnk/Networking}
make prefix=$RPM_BUILD_ROOT/usr/X11R6 install-strip

install %{SOURCE1} $RPM_BUILD_ROOT/etc/X11/applnk/Networking
install %{SOURCE2} $RPM_BUILD_ROOT/usr/X11R6/share/pixmaps
...
%attr(755,root,root) /usr/X11R6/bin/xchat
/etc/X11/applnk/Networking/xchat.desktop
/usr/X11R6/share/pixmaps/xchat.png
